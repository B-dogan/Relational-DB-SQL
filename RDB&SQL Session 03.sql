...
--Girdiğimiz ifadenin içindeki herhangi bir karakterle karşılaştığında bu karakter silinecektir. 
--Ta ki bu karakterler dışında başka bir karakterle kaşılaşana kadar.
